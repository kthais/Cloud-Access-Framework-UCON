...
public class SOAPSAMLXACMLPDPMessageReceiverInOut extends
		...
		try {
			...
			if ((op.getName() != null)
				...
				if ("authorize".equals(methodName)) {
					...
					MessageBody wrappedParam = (MessageBody) fromOM(
	...
	private MessageBody wrapAuthorize() {
		MessageBody wrappedElement = new MessageBody();
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (MessageBody.class
					.equals(type)) {

				return MessageBody.Factory
